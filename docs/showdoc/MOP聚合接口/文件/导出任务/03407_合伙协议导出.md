...
addtime: "2021-08-10 17:26:02"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=3407"
---
# 合伙协议导出

**请求URL：** 
- `/file/hr/partnershipAgreementExport `
...
|参数名|必选|类型|说明|
|:---- |:---|:----- |----- |
|exportType|否|Integer| 导出类型;按汇总:1;按明细:2;图片压缩包:3;PDF压缩包:4|
|sword|否|String||
|tokenId|否|String||
|id|否|String||
