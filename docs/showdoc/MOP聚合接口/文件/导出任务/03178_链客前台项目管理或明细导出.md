...
addtime: "2020-10-19 15:43:08"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=3178"
---
# 链客前台项目管理或明细导出

**请求URL：** 
- `/file/hr/taskManageExport `
...
|参数名|必选|类型|说明|
|:---- |:---|:----- |----- |
|exportType|是|Integer| 导出类型；1：按整单汇总导出，2：按明细导出|
|sword|否|String||
|tokenId|否|String||
|id|否|String||
