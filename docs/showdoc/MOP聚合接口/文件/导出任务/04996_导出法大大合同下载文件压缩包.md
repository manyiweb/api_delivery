...
addtime: "2022-01-11 17:27:52"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=4996"
---
# 导出法大大合同下载文件压缩包

**请求URL：** 
- `/file/hr/fddContractSigningRecord/exportFddContractZip `
...
|参数名|必选|类型|说明|
|:---- |:---|:----- |----- |
|exportFlag|否|Boolean| 导出查询标记;true:导出查询;false:非导出查询|
|sword|否|String||
|tokenId|否|String||
|id|否|String||
