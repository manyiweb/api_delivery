...
addtime: "2021-01-09 18:40:12"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=3408"
---
# 结款单导出

**请求URL：** 
- `/file/hr/settlementManageExport `
...
|参数名|必选|类型|说明|
|:---- |:---|:----- |----- |
|exportType|是|Integer| 导出类型；1：按整单汇总导出，2：按明细导出，3:导出PDF文件|
|sword|否|String||
|tokenId|否|String||
|id|否|String||
