...
addtime: "2021-08-06 18:15:23"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=4426"
---
# 根据门店id查询同城配送区域
 

**请求URL：** 
- `/app/manage/freeshippingrule/samecitytemplatedata `
...
|:---- |:---|:----- |----- |
|companyId|否|String||
|businessType|否|Integer| 1会员商城 2点餐商城|
|sword|否|String||
|tokenId|否|String||
|id|否|String||
