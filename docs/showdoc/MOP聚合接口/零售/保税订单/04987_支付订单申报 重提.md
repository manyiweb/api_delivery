...
addtime: "2022-01-07 11:32:00"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=4987"
---
# 支付申报 重新提交接口
 

**请求URL：** 
- `/dock/baoli/push/payOrderDeclation `
...
|:---- |:---|:----- |----- |
|orderId|否|String||
|isUpdata|否|Boolean| 是否已生成清单后修改电子订单（可不传）|
