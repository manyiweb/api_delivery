...
addtime: "2023-04-17 14:25:10"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=6528"
---
# 功能描述: 幸运大转盘-查询活动抽奖记录-导出
 服务：activity
 

**请求URL：** 
- `/activity/member/wheel/mall/record/export`
...
|hasPrizeType|否|Integer| 0-全部 1-中奖 2-未中奖|
|sword|否|String||
|tokenId|否|String||
|id|否|String||
