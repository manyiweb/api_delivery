...
addtime: "2022-11-22 09:45:25"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=6071"
---
# 获取企业会员赊销设置
 服务：config
...
|data|否|Object| 主数据|
|--id|否|Long| Id|
|--allMember|否|Integer| 应用所有会员（1-是，0-否）|
|--superMemberCreditDetailSet|否|Object| 企业会员赊销设置返回值明细分页|
