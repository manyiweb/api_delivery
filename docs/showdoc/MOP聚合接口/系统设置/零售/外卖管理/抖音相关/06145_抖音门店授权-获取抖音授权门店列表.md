...
addtime: "2023-07-11 14:37:10"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=6145"
---
# 获取抖音授权门店列表
 

**请求URL：** 
- `/dock/douyin/shop/list `
...
|----city|否|String| 城市|
|----accountId|否|String| 饿了么商户id|
|----poiId|否|String| 饿了么店铺id|
|----shopName|否|String| 抖音店铺名称|
|----open|否|Boolean| 是否开店|
|msg|否|String| 消息|
|code|否|String| 业务代码|
