...
addtime: "2023-05-11 15:20:41"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=6629"
---
# 查看批量操作记录列表

**请求URL：** 
- `config/batch/task/page`
...
|--content|否|List| 分页数据|
	...
	|--successNum|否|Long| 成功数|
	|--totalNum|否|Long| 总数|
	|--status|否|String| 操作状态|
	|--statusDesc|否|String||
