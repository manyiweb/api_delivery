...
addtime: "2020-06-24 14:24:56"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=2885"
---
# 分页获取活动标签绑定门店
 

**请求URL：** 
- `/product/activitylabel/company/action/list `
...
|--content|否|List| 分页数据|
|----id|否|Long||
|----activityLabelId|否|Long| 活动标签表id|
|----companyId|否|String| 商品id|
