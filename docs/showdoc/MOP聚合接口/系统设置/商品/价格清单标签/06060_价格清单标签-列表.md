...
addtime: "2022-11-21 09:52:59"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=6060"
---
# 查询商品标签列表

**请求URL：** 
- `/config/priceList/label/list`
...
|----code|否|String| 标签编码|
|----name|否|String| 标签名称|
|----isActive|否|Integer| 是否启用 1 - 启用，0 - 不停用|
