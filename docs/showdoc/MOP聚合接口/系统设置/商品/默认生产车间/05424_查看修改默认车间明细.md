...
addtime: "2022-05-26 17:44:47"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=5424"
---
# 查看修改默认车间明细

**请求URL：** 
- `/config/mitemWorkshop/record/page`
...
|----workshopNameBefore|否|String| 修改前默认车间|
|----workshopNameAfter|否|String| 修改后默认车间|
|msg|否|String| 消息|
|code|否|String| 业务代码|
