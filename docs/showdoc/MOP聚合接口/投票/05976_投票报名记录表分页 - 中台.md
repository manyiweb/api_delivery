---
page_id: "5976"
page_title: "投票报名记录表分页 - 中台"
item_id: "6"
cat_id: "857"
catalog_path:
  - "投票"
author_username: "baichenlin@reabam.com"
addtime: "2022-11-12 14:12:20"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=5976"
---
# 投票报名记录表分页
 

**请求URL：** 
- `/activity/vote/sign/up/apply/search/mgd`
...
|----last|否|Boolean| 尾页|
|----content|否|List| 分页数据|
|--totalVoters|否|Integer| 投票人数|
|--totalVotes|否|Integer| 总票数|
|--pv|否|Integer| 访问量|
|msg|否|String| 消息|
|code|否|String| 业务代码|
