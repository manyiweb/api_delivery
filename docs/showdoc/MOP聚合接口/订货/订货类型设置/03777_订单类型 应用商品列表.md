...
addtime: "2022-08-04 16:23:53"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=3777"
---
# 订单类型 应用商品列表
 

**请求URL：** 
- `/b2b/orderTypeConfig/b2bOrderTypeItemList `
...
|--content|否|List| 分页数据|
|----id|否|Long||
|----orderTypeId|否|Long| 关联b2b_order_type 表|
