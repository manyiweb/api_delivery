...
addtime: "2020-11-29 12:14:33"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=3309"
---
# 分页查询企业通联电子账户

**请求URL：** 
- `/hr/settlement/queryCompanyAccountPage `
...
|参数名|必选|类型|说明|
|:---- |:---|:----- |----- |
|queryType|是|Integer| 查询类型:1:结款查询,2:发放转出账户查询,3:发放中间账户查询|
|sword|否|String||
|tokenId|否|String||
|id|是|结款单主键id||
