...
addtime: "2021-02-22 14:35:14"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=3515"
---
# 运营物流仓分页列表查询

**请求URL：** 
- `/hr/staffLogiWhsStor/page `
...
|--last|否|Boolean| 尾页|
|--content|否|List| 分页数据|
|----logiWhsCode|否|String| 物流仓库编码|
|----logiWhsName|否|String| 物流仓库名称|
|----id|否|Long| id|
