...
addtime: "2023-05-05 14:57:04"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=1653"
---
# 获取智能补货单指定商户
 

**请求URL：** 
- `/product/smartReplenishment/list/comp`
...
|----avgDaySold|否|Integer| 前N天的平均销量(天数)|
|msg|否|String| 消息|
|code|否|String| 业务代码|
