...
addtime: "2022-02-15 18:08:36"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=5064"
---
# 分页-提货配送商品设置明细

**请求URL：** 
- `/product-manager/delivery/item/setting/detail/page`
...
|参数名|必选|类型|说明|
|:---- |:---|:----- |----- |
|specifiedMode|是|Integer| 指定模式:1-指定商品;2-指定分类/品牌/系列|
|sword|否|String||
|tokenId|否|String||
|id|否|String||
