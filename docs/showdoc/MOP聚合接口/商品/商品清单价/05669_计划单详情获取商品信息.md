...
addtime: "2022-08-06 16:55:29"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=5669"
---
# 调价计划单详情-获取商品信息

**请求URL：** 
- `/product/batch/price/adjustment/item`
...
|----afterAdjustPrice|否|String| 调价后清单价|
|msg|否|String| 消息|
|code|否|String| 业务代码|
