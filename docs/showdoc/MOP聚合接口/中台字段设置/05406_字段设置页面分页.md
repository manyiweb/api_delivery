...
addtime: "2022-05-18 17:04:24"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=5406"
---
# 字段设置页面分页

**请求URL：** 
- `/config/fieldSettingPage/page `
...
|isShow|否|Boolean| 是否显示,true=显示,false=不显示(非必填)|
|sword|否|String||
|tokenId|否|String||
|id|否|String||
