...
addtime: "2025-06-25 09:42:02"
source_url: "https://showdoc.reabam.com/web/#/6?page_id=10082"
---
# 产品线-列表

**请求URL：** 
- `/product/productLine/list`
...
|参数名|必选|类型|说明|
|:---- |:---|:----- |----- |
|isActive|否|Boolean| 活跃状态 true/false|
|sword|否|String||
|tokenId|否|String||
|id|否|String||
|orderField|否|String||
